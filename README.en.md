...
Supported Codex Desktop builds:

| Codex Desktop version | Build | Runtime patch notes |
| --- | --- | --- |
...
| `26.602.40724` | `3593` | Fast, the new `general-settings` and `composer` chunks, plugin install/connect flow, shared marketplace prefetch, OpenAI curated catalog visibility, and Appshot targets verified against the June 6, 2026 bundle. |
...
The current runtime patch flow has been tested and verified OK with Codex Desktop `26.519.41501`, `26.527.31326`, `26.527.60818`, `26.601.21317`, and `26.602.40724`. These patches do not bypass Codex account, workspace, admin, or service-tier requirements.
